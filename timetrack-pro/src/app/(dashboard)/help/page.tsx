                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                    {resources.map((item, i) => (
                        <motion.div
                            ...
                            whileHover={{ y: -4 }}
                            className={cn(
                                "group relative overflow-hidden rounded-[2rem] bg-white dark:bg-slate-900 p-6 sm:p-8 border border-slate-100 dark:border-slate-800 hover:shadow-xl dark:shadow-none hover:border-slate-200 dark:hover:border-slate-700 transition-all duration-300",
                                item.border
                            )}
                        >
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {faqs.map((faq, i) => (
                            <motion.div
                                ...
                                className="group rounded-[2rem] border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 lg:p-8 transition-all hover:border-[#1A5235]/20 dark:hover:border-emerald-500/20 hover:shadow-lg dark:hover:shadow-none hover:shadow-[#1A5235]/5"
                            >
                                <div className="flex gap-3 sm:gap-5">
                                    ...
                                    <div>
                                        <h4 className="text-base sm:text-lg font-black text-slate-800 dark:text-white mb-1.5 sm:mb-2">{faq.q}</h4>
                                        <p className="text-sm sm:text-base font-medium text-slate-500 dark:text-slate-400 leading-relaxed">{faq.a}</p>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
