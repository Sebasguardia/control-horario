    ...
    const handleGoogleLogin = async () => {
        ...
        if (error) {
            ...
            if (error.message.includes("provider is not enabled")) {
                userMessage = "El inicio de sesión con Google no está habilitado en la configuración del servidor.";
            }
            addNotification("Error de Autenticación", userMessage, "error");
