                ...
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {features.map((feature, i) => (
                        <motion.div
                            ...
                            whileHover={{ y: -10 }}
                            className="group relative rounded-[2.5rem] border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-12 transition-all hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.4)]"
                        >
                            <div className="mb-10 flex h-20 w-20 items-center justify-center rounded-3xl bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white group-hover:bg-emerald-600 group-hover:text-white transition-all transform group-hover:rotate-6">
                                <feature.icon className="h-9 w-9" />
                            </div>
                            <h3 className="mb-6 text-2xl font-black text-slate-900 dark:text-white tracking-tight leading-none">{feature.title}</h3>
                            <p className="text-lg leading-relaxed text-slate-500 dark:text-slate-400">{feature.desc}</p>
