        ...
        <section className="py-40 bg-white dark:bg-slate-950 overflow-hidden">
            <div className="container mx-auto px-6">
                <div className="mb-24 text-center max-w-3xl mx-auto">
                    <p className="text-sm font-black uppercase tracking-[0.4em] text-emerald-600 mb-6 font-mono tracking-[0.6em]">Prueba la Experiencia</p>
                    <h2 className="text-5xl font-black tracking-tighter text-slate-900 dark:text-white sm:text-7xl leading-none underline decoration-emerald-500/20 underline-offset-[12px]">
                ...
                <motion.div
                    ...
                    className="relative max-w-6xl mx-auto rounded-[3rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-[0_80px_160px_-40px_rgba(0,0,0,0.1)] dark:shadow-[0_80px_160px_-40px_rgba(0,0,0,0.6)] overflow-hidden"
                >
                    {/* Browser Toolbar Icons */}
                    <div className="h-14 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 flex items-center px-8 gap-2">
                    ...
                    <div className="flex h-[750px] flex-col lg:flex-row">
                        ...
                        {/* Main Panel */}
                        <div className="flex-1 p-8 lg:p-12 bg-slate-50 dark:bg-slate-950/50 relative">
                            {/* Header Stats */}
                            <div className="grid sm:grid-cols-3 gap-6 mb-12">
                                {[
                                    ...
                                    <div key={stat.label} className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-6">
                            ...
                            {/* Main Timer Display */}
                            <div className="rounded-[4rem] bg-slate-900 dark:bg-black p-12 lg:p-20 text-center text-white relative overflow-hidden group mb-12 shadow-2xl">
                                <p className="text-xs font-black uppercase tracking-[0.5em] text-emerald-400 mb-8 opacity-70">Temporizador Dinámico</p>
                                <motion.span
                                    className="text-7xl lg:text-[120px] font-black tabular-nums tracking-tighter leading-none"
